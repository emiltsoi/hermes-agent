...
_REASONING_STALE_TIMEOUT_FLOORS: dict[int, tuple[str, ...]] = {
    600: (
        ...
        "deepseek-r1", "deepseek-reasoner", "deepseek-flash", "deepseek-v4-flash", "deepseek-v4.1-flash",
        # Fleet: v4.1-pro + family key; separator right-anchor lets v4.1 derivatives inherit the floor.
        "deepseek-v4.1-pro", "deepseek-v4.1", "deepseek-v4-pro",
